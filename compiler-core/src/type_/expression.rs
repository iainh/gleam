...
pub struct Implementations {
    ...
    /// Whether the function has an implementation that uses external Cranelift
    /// code.
    pub uses_cranelift_externals: bool,
}
...
impl Implementations {
    ...
    pub fn update_from_use(
        ...
        let Implementations {
            ...
            uses_cranelift_externals: other_uses_cranelift_externals,
            can_run_on_erlang: other_can_run_on_erlang,
            can_run_on_javascript: other_can_run_on_javascript,
            can_run_on_cranelift: other_can_run_on_cranelift,
        } = implementations;
        let FunctionDefinition {
            has_body: _,
            has_erlang_external,
            has_javascript_external,
            has_cranelift_external,
        ...
        self.can_run_on_cranelift = *has_cranelift_external
            || (self.can_run_on_cranelift && (*gleam || *other_can_run_on_cranelift));
        ...
        self.uses_cranelift_externals =
            self.uses_cranelift_externals || *other_uses_cranelift_externals;
    }
...
impl<'a, 'b> ExprTyper<'a, 'b> {
    pub fn new(
        ...
        let implementations = Implementations {
            ...
            can_run_on_cranelift: definition.has_body || definition.has_cranelift_external,
            uses_erlang_externals: definition.has_erlang_external,
            uses_javascript_externals: definition.has_javascript_external,
            uses_cranelift_externals: definition.has_cranelift_external,
        };
